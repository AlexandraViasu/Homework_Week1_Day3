...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  #14 @unittest.skip("delete this line to run the test")
  ...
  def test_volume_of_cube(self):
    volume_of_a_cube = how_to_calculate_cube_volume( 5 ) 
    self.assertEqual( 125, volume_of_a_cube )

  #Given a String, return the String reversed
  @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    reverse_string = how_to_reverse_a_string( test_string )
    self.assertEqual( "Ardnaxela", reverse_string )

  #Given a value in farenheit, convert this into celsius.
  @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    we_need_celsius = how_to_calculate_celsius( 32 )
    self.assertEqual( 0, we_need_celsius )
